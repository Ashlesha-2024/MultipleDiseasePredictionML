...
heartd_model = pickle.load(open('heartdisease_model.sav','rb'))
breastc_model = pickle.load(open('breastcancer_model.sav','rb'))
parki_model = pickle.load(open('parkinsons_model.sav','rb'))
